...
{
    public GameObject[] color = new GameObject[16];
    ...
    public void color13Click() { colorMethod(13); }
    public void color14Click() { colorMethod(14); }
    public void color15Click() { colorMethod(15); }
    public void color16Click() { colorMethod(16); }
